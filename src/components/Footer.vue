<template>
	<footer class="footer d-flex justify-content-around align-items-center pb-5 px-5" role="contentinfo">
		<div>
			<div class="d-flex footerText text-left row p-4 justify-content-between">
				<ul class="col footerLink" role="list">
					...
					<li><router-link to="/allprojects"> Projets </router-link></li>
		...
		<ul role="list" class="d-flex">
			...
			<li class="mx-2"><a href="https://twitter.com/contact_school" title="Twitter de MyDigitalSchool - nouvel onglet"><img src="../assets/imgs/Rs/Twitter.png" alt="Twitter de MyDigitalSchool" /></a></li>
